...
/* Expose globally so Alpine x-data can access it at init time. */
    ...
    return {
      ...
      tryDeviceOrientation() {
        ...
        if (
          ...
          // iOS 13+ needs a user gesture; show prompt in UI
      ...
      layerStyle(layer) {
        ...
        const px =
          (this.hasMotion ? mobileIntensity : intensity) * depth;
